...
/*  Each option here is a hand-tuned, contrast-checked preset, so any    */
...
export const palettes: Record<string, { label: string; colors: Palette }> = {
  tomato: {
    ...
    colors: {
      bg: 'oklch(0.991 0.006 78)',
      surface: 'oklch(0.958 0.022 52)',
      ink: 'oklch(0.24 0.028 44)',
      muted: 'oklch(0.44 0.03 42)',
      primary: 'oklch(0.605 0.185 33)',
      'primary-deep': 'oklch(0.50 0.165 31)',
      'primary-tint': 'oklch(0.93 0.045 45)',
      pop: 'oklch(0.80 0.135 78)',
      'pop-deep': 'oklch(0.60 0.12 70)',
      line: 'oklch(0.89 0.016 58)',
    },
  },
  berry: {
    label: 'Berry & Rose (bright, playful)',
    colors: {
      bg: 'oklch(0.991 0.006 20)',
      surface: 'oklch(0.955 0.022 12)',
      ink: 'oklch(0.24 0.03 18)',
      muted: 'oklch(0.44 0.035 16)',
      primary: 'oklch(0.575 0.175 8)',
      'primary-deep': 'oklch(0.48 0.155 6)',
      'primary-tint': 'oklch(0.93 0.045 12)',
      pop: 'oklch(0.82 0.10 350)',
      'pop-deep': 'oklch(0.60 0.12 356)',
      line: 'oklch(0.89 0.016 16)',
    },
  },
  olive: {
    label: 'Olive & Honey (earthy, calm)',
    colors: {
      bg: 'oklch(0.99 0.007 120)',
      surface: 'oklch(0.955 0.02 118)',
      ink: 'oklch(0.25 0.022 140)',
      muted: 'oklch(0.45 0.026 138)',
      primary: 'oklch(0.53 0.105 138)',
      'primary-deep': 'oklch(0.45 0.095 138)',
      'primary-tint': 'oklch(0.93 0.04 128)',
      pop: 'oklch(0.80 0.13 84)',
      'pop-deep': 'oklch(0.585 0.11 80)',
      line: 'oklch(0.89 0.015 120)',
    },
  },
  cocoa: {
    label: 'Cocoa & Gold (cozy, refined)',
    colors: {
      bg: 'oklch(0.99 0.007 70)',
      surface: 'oklch(0.955 0.02 66)',
      ink: 'oklch(0.24 0.024 58)',
      muted: 'oklch(0.44 0.028 56)',
      primary: 'oklch(0.475 0.075 54)',
      'primary-deep': 'oklch(0.40 0.065 52)',
      'primary-tint': 'oklch(0.92 0.032 58)',
      pop: 'oklch(0.78 0.125 82)',
      'pop-deep': 'oklch(0.575 0.105 78)',
      line: 'oklch(0.89 0.015 62)',
    },
  },
  ocean: {
    label: 'Ocean & Coral (fresh, coastal)',
    colors: {
      bg: 'oklch(0.991 0.006 220)',
      surface: 'oklch(0.955 0.02 225)',
      ink: 'oklch(0.24 0.03 240)',
      muted: 'oklch(0.44 0.035 238)',
      primary: 'oklch(0.55 0.12 242)',
      'primary-deep': 'oklch(0.46 0.11 244)',
      'primary-tint': 'oklch(0.93 0.04 235)',
      pop: 'oklch(0.76 0.135 36)',
      'pop-deep': 'oklch(0.60 0.14 34)',
      line: 'oklch(0.89 0.016 228)',
    },
  },
};
...
export const fontPairings: Record<string, FontPairing> = {
  ...
  cormorant: {
    ...
    googleFamilies: [
      ...
      'Nunito+Sans:opsz,wght@6..12,400;6..12,500;6..12,600;6..12,700',
    ],
  },
};
